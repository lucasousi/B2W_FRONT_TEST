import './firemons-store-home.scss';
...
export const FiremonsStoreHome = () => {
  const fireTypeID = 10;
  const pokemonsPerPage = 12;
  const fakeArrayToLoadingSkeleton = [...Array(pokemonsPerPage).keys()];
  const pageTitle = 'Loja de pokémons do tipo Fogo';
  const pageSubtitle = 'Aqui você encontra os principais pokémons de fogo para sua pokedéx.';
  ...
  useEffect(() => {
    ...
    getSummarizedPokemons(fireTypeID);
...
export default FiremonsStoreHome;
